...
//                continue;
//            }
// null.compareTo(checkinDate)
//            if (library.get(i).getDueDate().compareTo(checkinDate) < 0) {
//                overdueBooks.add(library.get(i));
//            }
// library.get(i).getDueDate() after checkInDate
//            null.after(checkInDate) -> error
//            checkInDate.before(null) -> false
            if (checkinDate.after(library.get(i).getDueDate())) {
                overdueBooks.add(library.get(i));
            }
        }
        return overdueBooks;
